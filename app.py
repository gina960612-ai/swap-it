...
def browse_page(user: User) -> None:
    st.markdown("<h1 style='color: #7B5BA3; margin-bottom: 24px;'>瀏覽物品</h1>", unsafe_allow_html=True)
...
def my_items_page(user: User) -> None:
    st.markdown("<h1 style='color: #7B5BA3; margin-bottom: 24px;'>我的物品</h1>", unsafe_allow_html=True)
...
def requests_and_chat_page(user: User) -> None:
    st.markdown("<h1 style='color: #7B5BA3; margin-bottom: 24px;'>交換請求與聊天</h1>", unsafe_allow_html=True)
    incoming_count, rejected_count = notification_counts(db(), user.user_id)
...
def profile_page(user: User) -> None:
    st.markdown("<h1 style='color: #7B5BA3; margin-bottom: 24px;'>個人資料</h1>", unsafe_allow_html=True)
...
def history_page(user: User) -> None:
    st.markdown("<h1 style='color: #7B5BA3; margin-bottom: 24px;'>歷史交易</h1>", unsafe_allow_html=True)
